...
namespace VAWC_Recording_System.NewForms
{
    public partial class NewCase : Form
    {
        ...
        {
            compIDtxtb.Text = CompGenerateAutoID().ToString();
            respoIDtxtb.Text = ResGenerateAutoID().ToString();
            caseNotxtb.Text = CaseGenerateAutoID().ToString();
            ...
            if (cmbxRA.SelectedItem != null)
            {
                ...
                switch (selectedCategory)
                {
                    ...
                    case "Revised Penal Code":
                        cmbxVS.Items.Add("Art 336: Acts of Laschiviousness");
                        cmbxVS.Items.Add("Others");
